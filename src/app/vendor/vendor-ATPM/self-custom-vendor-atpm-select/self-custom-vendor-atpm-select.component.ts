...
@Component({
  selector: 'app-self-custom-vendor-atpm-select',
  templateUrl: './self-custom-vendor-atpm-select.component.html'
})
export class SelfCustomVendorAtpmSelectComponent implements OnInit {
