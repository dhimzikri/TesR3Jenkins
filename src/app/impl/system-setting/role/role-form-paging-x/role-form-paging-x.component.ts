...
@Component({
  selector: 'app-role-form-paging-x',
  templateUrl: './role-form-paging-x.component.html'
})
export class RoleFormPagingXComponent implements OnInit {

  RefRoleId: string;
  inputPagingObj: UcPagingObj = new UcPagingObj(this.UrlConstantNew);
  viewGenericObj: UcViewGenericObj = new UcViewGenericObj(this.UrlConstantNew);

  readonly CancelLink: string = NavigationConstant.SYSTEM_SETTING_ROLE_X;
  ...
  ngOnInit() {
    ...
    this.inputPagingObj._url = "./assets/impl/ucpaging/searchRoleRefFormX.json";
    this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/searchRoleRefFormX.json";
