...
import { CustomerPersonalDetailComponent } from 'app/customer/customer-personal/customer-personal-detail/customer-personal-detail.component';
...
import { CustomerPersonalJobDataComponent } from 'app/customer/customer-personal/customer-personal-job-data/customer-personal-job-data.component';
...
export class CustomerPersonalPageXComponent implements OnInit {
  ...
  endStepper(ev: any) {
    if (this.From) {
      AdInsHelper.RedirectUrl(this.ngxRouter, ["/" + PathConstant.LR_CUST + "/" + this.From + "/" + PathConstantX.PAGING_X], {});
    } else {
