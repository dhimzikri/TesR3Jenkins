...
@Component({
  ...
  templateUrl: './vendor-ho-add-edit-x.component.html'
})
export class VendorHoAddEditXComponent implements OnInit {
  ...
  VendorForm = this.fb.group({
    ...
    IsSyariah: [false],
    VendorAtpmCode: [],
    AcquisitionCost: ['', [Validators.required, Validators.min(1), Validators.max(100)]],
  })
  ...
  SetTitleHoInfo() {
    switch (this.MrVendorCategoryCode) {
      case CommonConstant.SUPPLIER_HO:
        ...
        this.Code = "Supplier Ho Code";
        this.Name = "Supplier Ho Name";
        this.Types = "Supplier Ho Type";
        break;
      case CommonConstant.SUPPLIER_HOLDING:
        this.HoTitle = "Supplier Holding ";
        this.Code = "Supplier Holding Code";
        this.Name = "Supplier Holding Name";
        this.Types = "Supplier Holding Type";
        break;
      ...
      case CommonConstant.SURVEYOR_HO:
        ...
        this.Code = "Surveyor Ho Code";
        this.Name = "Surveyor Ho Name";
        this.Types = "Surveyor Ho Type";
        break;
      case CommonConstant.SURVEYOR_BRANCH:
        this.HoTitle = "Surveyor Branch ";
        this.Code = "Surveyor Branch Code";
        this.Name = "Surveyor Branch Name";
        this.Types = "Surveyor Branch Type";
        break;
      case CommonConstant.ASSET_INSCO_HO:
        this.HoTitle = "Insurance HO ";
        this.Code = "Insco Ho Code";
        this.Name = "Insco Ho Name";
        this.Types = "Insco Ho Type";
      ...
      case CommonConstant.LIFE_INSCO_HO:
        ...
        this.Code = "Life Insco Ho Code";
        this.Name = "Life Insco Ho Name";
        this.Types = "Life Insco Ho Type";
        this.VendorForm.get("MrTaxCalcMethodCode").clearValidators();
        this.VendorForm.get("MrTaxCalcMethodCode").updateValueAndValidity();
        this.VendorForm.get("IsVat").clearValidators();
        this.VendorForm.get("IsVat").updateValueAndValidity();
      ...
      case CommonConstant.LIFE_INSCO_BRANCH:
        ...
        this.Code = "Life Insco Branch Code";
        this.Name = "Life Insco Branch Name";
        this.Types = "Life Insco Branch Type";
        this.VendorForm.get("MrTaxCalcMethodCode").clearValidators();
        this.VendorForm.get("MrTaxCalcMethodCode").updateValueAndValidity();
        this.VendorForm.get("IsVat").clearValidators();
        this.VendorForm.get("IsVat").updateValueAndValidity();
    ...
    await this.http.post(this.UrlConstantNew.GetVendorAndVendorAddr, ReqGetVendorAndVendorAddr).toPromise().then(
      async (response) => {
        ...
        this.VendorForm.patchValue({
          ...
          // IsSyariah: this.result.VendorObj.IsActive,
  ...
  Back() {
    if (this.mode == "edit") {
      AdInsHelper.RedirectUrl(this.ngxRouter, [NavigationConstant.VENDOR_HO_REG_X], { "VendorId": this.VendorId, "mode": "edit", "MrVendorCategoryCode": this.MrVendorCategoryCode });
    } else {
  ...
  SaveForm() {
    if (Date.parse(this.VendorForm.controls.EstablishmentDt.value) > Date.parse(formatDate(this.businessDt, 'yyyy-MM-dd', 'en-US'))) {
      ...
      this.vendorHoObj.VendorObj.IsSyariah = this.VendorForm.controls.IsSyariah.value;
      ...
      this.vendorHoObj.VendorObj.AcquisitionCost = this.VendorForm.controls.AcquisitionCost.value;
      ...
      if (this.mode == "edit") {
        ...
        let reqEditVendorHOObjX: any = {
          isSyariah: this.vendorHoObj.VendorObj.IsSyariah,
          acquisitionCost: this.vendorHoObj.VendorObj.AcquisitionCost,
          vendorHoObj: this.vendorHoObj,
        };
        this.http.post<GenericObj>(this.UrlConstantNew.EditVendorHOX, reqEditVendorHOObjX, AdInsConstant.SpinnerOptions).subscribe(
          (response) => {
            this.toastr.successMessage(response["message"]);
            AdInsHelper.RedirectUrl(this.ngxRouter, [NavigationConstant.VENDOR_HO_REG_X], { "VendorId": response.Id, "mode": "edit", "MrVendorCategoryCode": this.MrVendorCategoryCode });
          });
      }
      else {
        this.vendorHoObj.VendorObj.MrVendorCategoryCode = this.MrVendorCategoryCode;
        let reqAddVendorHOObjX: any = {
          isSyariah: this.vendorHoObj.VendorObj.IsSyariah,
          acquisitionCost: this.vendorHoObj.VendorObj.AcquisitionCost,
          vendorHoObj: this.vendorHoObj,
        };
        this.http.post<GenericObj>(this.UrlConstantNew.AddVendorHOX, reqAddVendorHOObjX, AdInsConstant.SpinnerOptions).subscribe(
          (response) => {
            this.toastr.successMessage(response["message"]);
            AdInsHelper.RedirectUrl(this.ngxRouter, [NavigationConstant.VENDOR_HO_REG_X], { "VendorId": response.Id, "MrVendorCategoryCode": this.MrVendorCategoryCode });
          });
      }
    }
  }
  ...
  async getVendorX(){
    ...
    if (result2!=null){
      this.VendorForm.patchValue({
        IsSyariah:result2.IsSyariah,
        AcquisitionCost: result2.AcquisitionCost,
      });
