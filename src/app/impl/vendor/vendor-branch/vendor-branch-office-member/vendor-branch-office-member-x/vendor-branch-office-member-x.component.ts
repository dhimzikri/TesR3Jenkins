...
@Component({
  selector: 'app-vendor-branch-office-member-x',
  templateUrl: './vendor-branch-office-member-x.component.html'
})
export class VendorBranchOfficeMemberXComponent implements OnInit {
  inputPagingObj: UcPagingObj = new UcPagingObj(this.UrlConstantNew);
  VendorId: string;
  objPassing: any = {};
  MrVendorCategoryCode: string = "";

  CancelLink: string = NavigationConstant.VENDOR_PAGING_X;
  readonly AddLink: string = NavigationConstant.VENDOR_BRANCH_MBR_ADD_X;
  ...
  ngOnInit() {
    this.inputPagingObj._url = "./assets/impl/ucpaging/searchVendorOfficeMemberX.json";
    this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/searchVendorOfficeMemberX.json";
    this.inputPagingObj.deleteUrl = this.UrlConstantNew.DeleteVendorOfficeMemberX;
