...
@Component({
  selector: 'app-vendor-paging-x',
  templateUrl: './vendor-paging-x.component.html'
})
export class VendorPagingXComponent implements OnInit, OnDestroy {
  ...
  selectPage() {
    ...
    if (this.Type == "Scheme") {
      ...
      if (this.MrVendorCategoryCode == CommonConstant.SUPPLIER || this.MrVendorCategoryCode == CommonConstant.ASSET_INSCO_BRANCH || this.MrVendorCategoryCode == CommonConstant.LIFE_INSCO_BRANCH
        ...
        switch (this.MrVendorCategoryCode) {
          case CommonConstant.SUPPLIER:
            this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/searchSupplierX.json";
            this.inputPagingObj._url = "./assets/impl/ucpaging/searchSupplierX.json";
            break;
          case CommonConstant.AGENCY_PERSONAL:
          ...
          case CommonConstant.NOTARY_PERSONAL: 
            this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/verification/searchNotaryPersonalX.json";
            this.inputPagingObj._url = "./assets/impl/ucpaging/verification/searchNotaryPersonalX.json";
          ...
          case CommonConstant.NOTARY_COMPANY: 
            this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/verification/searchNotaryCompanyX.json";
            this.inputPagingObj._url = "./assets/impl/ucpaging/verification/searchNotaryCompanyX.json";
            this.inputPagingObj.title = typeof (CommonConstant["TITLE_" + this.MrVendorCategoryCode]) != 'undefined' ? CommonConstant["TITLE_" + this.MrVendorCategoryCode] : this.MrVendorCategoryCode.replace(/_/g, ' ');
            this.inputPagingObj.addCritInput = new Array();
            var critObj = new CriteriaObj();
            critObj.propName = "vdr.MR_VENDOR_CATEGORY_CODE";
          ...
          case CommonConstant.AUCTION_COMPANY: 
            this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/searchAuctionCompanyV2X.json";
            this.inputPagingObj._url = "./assets/impl/ucpaging/searchAuctionCompanyV2X.json";
            this.inputPagingObj.title = typeof (CommonConstant["TITLE_" + this.MrVendorCategoryCode]) != 'undefined' ? CommonConstant["TITLE_" + this.MrVendorCategoryCode] : this.MrVendorCategoryCode.replace(/_/g, ' ');
            this.inputPagingObj.addCritInput = new Array();
            var critObj = new CriteriaObj();
            critObj.propName = "vdr.MR_VENDOR_CATEGORY_CODE";
          ...
          case CommonConstant.VENDOR_CATEGORY_GENERAL:
            this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/searchVendorGeneralX.json";
            this.inputPagingObj._url = "./assets/impl/ucpaging/searchVendorGeneralX.json";
            this.inputPagingObj.addCritInput = new Array();
            var critObj = new CriteriaObj();
            critObj.propName = "vdr.MR_VENDOR_CATEGORY_CODE";
            critObj.restriction = AdInsConstant.RestrictionIn;
            critObj.listValue = ["CONSULTANT", "LOGISTIC", "COURIER", "IT_INFRA_SOLUTION", "GENERAL"]; //tambah GENERAL, temporary(perlu perbaikan core)
            this.inputPagingObj.addCritInput.push(critObj);
            break;
          default:
            this.inputPagingObj.pagingJson = "./assets/impl/searchBranchX.json";
            this.inputPagingObj._url = "./assets/impl/searchBranchX.json";
            break;
        }
        ...
        this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/searchVendorHOX.json";
        this.inputPagingObj._url = "./assets/impl/ucpaging/searchVendorHOX.json";
  ...
  navigate() {
    if (this.MrVendorCategoryCode == CommonConstant.SUPPLIER || this.MrVendorCategoryCode == CommonConstant.ASSET_INSCO_BRANCH || this.MrVendorCategoryCode == CommonConstant.LIFE_INSCO_BRANCH || this.MrVendorCategoryCode == CommonConstant.SURVEYOR_BRANCH || this.MrVendorCategoryCode == CommonConstant.AGENCY_COMPANY || this.MrVendorCategoryCode == CommonConstant.AGENCY_PERSONAL
      ...
      AdInsHelper.RedirectUrl(this.ngxRouter, [NavigationConstant.VENDOR_BRANCH_ADD_X], { "MrVendorCategoryCode": this.MrVendorCategoryCode });
    }
    else if (this.MrVendorCategoryCode == CommonConstant.ASSET_INSCO_HO || this.MrVendorCategoryCode == CommonConstant.LIFE_INSCO_HO || this.MrVendorCategoryCode == CommonConstant.SUPPLIER_HO || this.MrVendorCategoryCode == CommonConstant.SURVEYOR_HO) {
      AdInsHelper.RedirectUrl(this.ngxRouter, [NavigationConstant.VENDOR_HO_DETAIL_X], { "MrVendorCategoryCode": this.MrVendorCategoryCode });
    }
    else if (this.MrVendorCategoryCode == CommonConstant.SUPPLIER_HOLDING) {
      ...
      AdInsHelper.RedirectUrl(this.ngxRouter, [NavigationConstant.VENDOR_BRANCH_ADD_X]);
    }
