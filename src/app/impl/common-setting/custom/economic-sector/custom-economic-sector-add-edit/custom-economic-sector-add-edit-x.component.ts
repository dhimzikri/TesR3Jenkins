...
@Component({
  selector: 'app-custom-economic-sector-add-edit-x',
  templateUrl: './custom-economic-sector-add-edit-x.component.html'
})
export class CustomEconomicSectorAddEditXComponent implements OnInit {

  pageName: string;
  dataEvent: EventEmitter<any> = new EventEmitter<any>();

  constructor(private UrlConstantNew: UrlConstantNew, private http: HttpClient) {
    this.pageName = "EconomicSectorDetailXCNAF"
  }
