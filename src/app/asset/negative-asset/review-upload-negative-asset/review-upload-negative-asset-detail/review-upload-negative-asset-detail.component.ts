...
export class ReviewUploadNegativeAssetDetailComponent implements OnInit {
  ...
  cancel() {
    ...
    wfObj.ListValue["WfCode"] = CommonConstant.WorkflowUploadNegativeAsset;
    ...
    this.http.post(this.UrlConstantNew.CancelUploadV2, wfObj, AdInsConstant.SpinnerOptions).subscribe(
      response => {
        ...
        this.router.navigateByUrl('/', { skipLocationChange: true }).then(() => {
          AdInsHelper.RedirectUrl(this.ngxRouter,[NavigationConstant.ASSET_NEG_RVW_UPLOAD_PAGING],{});
      }); 
      }
    );
  }
