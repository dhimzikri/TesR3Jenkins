...
@Component({
  selector: 'app-self-custom-fin-data-tab',
  templateUrl: './self-custom-fin-data-tab.component.html',
  styleUrls: [],
 // providers: [NGXToastrService]
})
export class SelfCustomCustFinDataTabComponent implements OnInit {
  ...
  async saveCustAttrContentAndNext(IsParent: boolean = false): Promise<boolean> {
    console.log(this.CustAttrListForm);
