...
export class SelfCustomNewCustHeaderShareholderComponent implements OnInit {
  //#region Readonly
  ...
  Cancel() {
    ...
    switch (this.From) {
      ...
      case CommonConstant.CustFromCustFamily:
        ...
        break;
      case CommonConstant.CustFromCustShareholder:
        AdInsHelper.RedirectUrl(this.ngxRouter, [NavigationConstant.SELF_CUSTOM_CUST_SHRHLDR_PAGING], {});
        break;
      case "CustGuarantor":
