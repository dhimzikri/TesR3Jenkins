...
@Component({
  selector: 'app-custom-update-customer-personal-detail',
  templateUrl: './custom-update-customer-personal-detail.component.html',
})
export class CustomUpdateCustomerPersonalDetailComponent implements OnInit {
