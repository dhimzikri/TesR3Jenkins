...
@Component({
  selector: 'app-custom-document-survey-task-view',
  templateUrl: './custom-document-survey-task-view.component.html'
})
export class CustomDocumentSurveyTaskViewComponent implements OnInit {
