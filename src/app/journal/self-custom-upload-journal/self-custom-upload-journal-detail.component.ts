...
@Component({
  selector: 'app-self-custom-upload-journal-detail',
  templateUrl: './self-custom-upload-journal-detail.component.html'
})
export class SelfCustomUploadJournalDetailComponent implements OnInit {
  ...
  FileCode: string;
  businessDt: string;
  readonly CancelLink: string = NavigationConstant.SELF_CUSTOM_UPLOAD_JOURNAL_FILE_PAGING;
