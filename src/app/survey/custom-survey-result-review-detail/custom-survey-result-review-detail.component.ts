...
@Component({
  selector: 'app-custom-survey-result-review-detail',
  templateUrl: './custom-survey-result-review-detail.component.html'
})
export class CustomSurveyResultReviewDetailComponent implements OnInit {
