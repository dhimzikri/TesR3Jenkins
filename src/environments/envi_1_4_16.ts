...
export const environment = {
    ...
    losUrl: 'https://r3app-server.ad-ins.com/1.4.16/LOS',
    FoundationR3Url: 'https://r3app-server.ad-ins.com/1.4.16/FOUNDATION',
    ...
    ApprovalR3Url: 'https://r3app-server.ad-ins.com/1.4.16/APPROVAL_R3_BE',
    ApprovalURL: 'https://r3impl-appsvr.ad-ins.com/APPROVAL_DSF_R3_SIT',
    FoundationR3Web: 'https://r3web-server.ad-ins.com/1.4.16/FOUNDATION',
    losR3Web: 'https://r3web-server.ad-ins.com/1.4.16/LOS',
